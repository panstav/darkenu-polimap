	...
	var regions = [
		{
			...
			link: 'http://www.facebook.com/groups/290075724414129/'
		},{
			region: { x: 331, y: 964 },
			irgun: false,
			color: 'aqua',
			...
			desc: ['קבוצת שטח של פעילי שכונות ופריפריה הפועלת במטרה לצמצם את הפערים החברתיים-כלכליים ולבטל את מושג הפריפריה מהשיח הציבורי'],
			link: 'https://www.facebook.com/pages/%D7%9C%D7%90-%D7%A0%D7%97%D7%9E%D7%93%D7%99%D7%9D-%D7%9C%D7%90-%D7%A0%D7%97%D7%9E%D7%93%D7%95%D7%AA/485312398245672'
		},{
			region: { x: 244, y: 976 },
			irgun: false,
			color: 'aqua',
			...
			link: 'http://www.tarabut.info/he/home/'
		},{
			region: { x: 154, y: 1131 },
			irgun: false,
			color: 'aqua',
			...
			link: 'https://www.facebook.com/nizolim/'
		},{
			region: { x: 63, y: 1141 },
			irgun: false,
			color: 'aqua',
			...
			link: 'https://www.facebook.com/groups/106870782717682/'
		},{
			region: { x: 72, y: 872 },
			irgun: false,
			color: 'aqua',
			...
			link: 'http://www.facebook.com/groups/alefzeaba/'
		},{
			region: { x: 343, y: 718 },
			irgun: false,
			color: 'aqua',
			...
			desc: ['הקואליציה פועלת בכמה מישורים במקביל','פעילות בכנסת כארגון חברתי אזרחי לקידום חקיקה בנושא.','קידום חקיקת חוק המשפחות המיוחדות שלראשונה, אם יעבור, יביא להכרה וזכויות לכל המשפחה כמשפחה עם צרכים מיוחדים ולא רק לילד עצמו.','שינוי חוקים קיימים או הוספת תיקונים לחוקים קיימים.','הסברה – הסברה לגורמים בתוך מערכת החינוך, סטודנטים לחינוך, לציבור הכללי ולציבורים ספציפיים על ציבור המשפחות המיוחדות. על הילדים המיוחדים וההתמודדויות והקשיים שלהם.','עזרה – הורים שנתקלים בקשיים מקשיים שונים פונים לקואליציה ומקבלים עזרה מהורים אחרים שפעילים בקואליציה או מופנים לארגונים ועמותות אחרות שיכולות לעזור.'],
			link: 'https://www.facebook.com/special.families.il/'
		},{
			region: { x: 338, y: 1055 },
			irgun: false,
			color: 'aqua',
			...
			link: 'https://www.facebook.com/groups/486608808152045/'
		},{
			region: { x: 383, y: 888 },
			irgun: true,
			color: 'aqua',
			...
			link: 'http://www.ha-keshet.org.il/'
		},{
			region: { x: 252, y: 746 },
			irgun: true,
			color: 'aqua',
			...
			link: 'http://www.fightracism.org/index.asp'
		},{
			region: { x: 150, y: 963 },
			irgun: false,
			color: 'aqua',
			...
			link: 'https://www.facebook.com/no2oni/'
		},{
			region: { x: 183, y: 676 },
			irgun: true,
			color: 'aqua',
			...
			link: 'https://www.facebook.com/groups/j12TLV/'
		},{
			region: { x: 520, y: 1035 },
			irgun: false,
			color: 'yellow',
			...
			link: 'http://israelaffordablehousing.blogspot.co.il/'
		},{
			region: { x: 418, y: 1167 },
			irgun: false,
			color: 'yellow',
			...
			link: 'https://www.facebook.com/SoftwareTLV.coop/'
		},{
			region: { x: 357, y: 1373 },
			irgun: false,
			color: 'yellow',
			...
			link: 'http://www.facebook.com/groups/109098332590511/'
		},{
			region: { x: 693, y: 1093 },
			irgun: false,
			color: 'yellow',
			...
			link: 'https://www.facebook.com/groups/531473386867477/'
		},{
			region: { x: 867, y: 1351 },
			irgun: false,
			color: 'yellow',
			...
			link: 'http://www.facebook.com/agalacoop?fref=ts'
		},{
			region: { x: 737, y: 1270 },
			irgun: false,
			color: 'yellow',
			...
			link: 'https://www.facebook.com/yogacoopertive'
		},{
			region: { x: 603, y: 1276 },
			irgun: false,
			color: 'yellow',
			...
			link: 'https://www.facebook.com/havrutak8/'
		},{
			region: { x: 544, y: 1355 },
			irgun: false,
			color: 'yellow',
			...
			link: 'http://www.facebook.com/yogabagalil/'
		},{
			region: { x: 831, y: 1269 },
			irgun: false,
			color: 'yellow',
			...
			link: 'http://organicsolde.wix.com/organicsolde'
		},{
			region: { x: 450, y: 1352 },
			irgun: false,
			color: 'yellow',
			...
			link: 'https://www.facebook.com/aplaceforthetribe/'
		},{
			region: { x: 734, y: 1265 },
			irgun: false,
			color: 'yellow',
			...
			link: 'https://www.facebook.com/groups/badkayma/'
		},{
			region: { x: 357, y: 184 },
			irgun: false,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/givatamal/'
		},{
			region: { x: 399, y: 540 },
			irgun: false,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/Powertothecommunity/'
		},{
			region: { x: 68, y: 531 },
			irgun: true,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/negevfuture/'
		},{
			region: { x: 66, y: 526 },
			irgun: true,
			color: 'bordo',
			...
			link: 'http://www.torhamidbar.org.il/%D7%94%D7%97%D7%9E%D7%9E%D7%94-%D7%94%D7%A7%D7%94%D7%99%D7%9C%D7%AA%D7%99%D7%AA-%D7%99%D7%99%D7%96%D7%95%D7%9D-%D7%A7%D7%94%D7%99%D7%9C%D7%95%D7%AA/'
		},{
			region: { x: 59, y: 341 },
			irgun: false,
			color: 'bordo',
			...
			link: 'http://www.facebook.com/groups/232526163462343/'
		},{
			region: { x: 368, y: 629 },
			irgun: false,
			color: 'bordo',
			...
			link: 'http://www.facebook.com/youngnegev/'
		},{
			region: { x: 115, y: 270 },
			irgun: false,
			color: 'bordo',
			...
			link: 'http://yeruhamactiveforjustice.wordpress.com/'
		},{
			region: { x: 307, y: 266 },
			irgun: false,
			color: 'bordo',
			...
			link: 'http://www.facebook.com/groups/224215580955137/'
		},{
			region: { x: 371, y: 328 },
			irgun: false,
			color: 'bordo',
			...
			link: 'http://nordautent.wordpress.com/'
		},{
			region: { x: 427, y: 250 },
			irgun: false,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/groups/332866690121889/'
		},{
			region: { x: 565, y: 379 },
			irgun: false,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/J14.Israel.k8/'
		},{
			region: { x: 81, y: 432 },
			irgun: false,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/negevawake/'
		},{
			region: { x: 234, y: 326 },
			irgun: false,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/j14.ta.1/'
		},{
			region: { x: 153, y: 360 },
			irgun: false,
			color: 'bordo',
			...
			link: 'https://www.facebook.com/wakeupsderot/'
		}
	];
